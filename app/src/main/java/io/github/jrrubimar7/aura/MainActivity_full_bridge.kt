...
class MainActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
                ...
                webView.evaluateJavascript(
                    ...
                    (function(){
                      try{
                        ...
                        window.__ANDROID_CLIPS_READY__ = (typeof Android !== 'undefined' && Android && typeof Android.openFile === 'function');
                        ...
                        console.log('ANDROID_CLIPS_READY=' + window.__ANDROID_CLIPS_READY__);
                      }catch(e){}
                    })();
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            ...
            REQ_FILE -> {
                ...
                sendClipToJS(uri?.toString() ?: "")
            }
            REQ_CAMERA -> {
                sendClipToJS("camera://image")
            }
        }
    }
    ...
    private fun sendClipToJS(value: String) {
        runOnUiThread {
            val safe = value
                .replace("\\", "\\\\")
                .replace("'", "\\'")
                ...
                .replace("\r", "")
            webView.evaluateJavascript(
                "window.onNativeClip && window.onNativeClip('$safe')",
                null
            )
        }
    }
